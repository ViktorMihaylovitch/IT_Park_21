...
public class ConverterRunner {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Введи пожалуйста исходную единицу измерения (возможные варианты - C, K, F):");
        String temperatureSystem = scanner.next();
        System.out.println("Введи пожалуйста единицу измерения, в которую будет переводено введенное значение (возможные варианты - C, K, F):");
